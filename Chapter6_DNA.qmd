...
This is not an academic review, those are far more comprehencive, see for example @benegas2025.
...
There are two specific architectural innovations, the first is GPA-MSA, a model we discussed in Chapter 4 where the embedding layer is adjusted to reflect the evolutionary history of the genome at a give base.
...
| GNA-MSA | The Genomic Pre-trained Network that leverage multiple sequenece alignment across species to develop specialized evolution aware token embedding. | [GPN-MSA preprint](https://pubmed.ncbi.nlm.nih.gov/37873118/) | [GitHub](https://github.com/songlab-cal/gpn) |
